...
class CheckTemplateVerifyTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        bare_ctv_position_2 = create_transaction_to_script(self.nodes[0], wallet, get_coinbase(),
        ...
        bare_ctv_specific_scriptSigs = create_transaction_to_script(self.nodes[0], wallet, get_coinbase(),
        ...
        bare_ctv_specific_scriptSigs_position_2 = create_transaction_to_script(self.nodes[0], wallet, get_coinbase(),
