            ...
            RPCResult{"if verbose is set to true",
                ...
                "       \"value\" : x.xxx,            (numeric) The value in " +
                    CURRENCY_UNIT + "\n"
                                    ...
                                    "  \"blocktime\" : ttt         (numeric) The block time expressed in " +
                    UNIX_EPOCH_TIME + "\n"
...
UniValue utxoupdatepsbt(const JSONRPCRequest& request)
{
    RPCHelpMan{"utxoupdatepsbt",
        ...
        RPCResult{"  \"psbt\"          (string) The base64-encoded partially signed transaction with inputs updated\n"}, RPCExamples{HelpExampleCli("utxoupdatepsbt", "\"psbt\"")}}
        .Check(request);
...
UniValue analyzepsbt(const JSONRPCRequest& request)
{
    RPCHelpMan{"analyzepsbt",
        ...
        RPCResult{
            ...
            "  \"estimated_feerate\" : feerate   (numeric, optional) Estimated feerate of the final signed transaction in " +
            CURRENCY_UNIT + "/kB. Shown only if all UTXO slots in the PSBT have been filled.\n"
