...
static const std::string TransactionDescriptionString()
{
    return "    \"confirmations\": n,                        (numeric) The number of confirmations for the transaction. Negative confirmations means the\n"
           ...
           "    \"blocktime\" : xxx,                          (numeric) The block time expressed in " +
           UNIX_EPOCH_TIME + ".\n"
                             ...
                             "      ...\n"
                             "    ],\n"
                             "    \"time\" : xxx,                               (numeric) The transaction time expressed in " +
           UNIX_EPOCH_TIME + ".\n"
                             "    \"timereceived\" : xxx,                       (numeric) The time received expressed in " +
           UNIX_EPOCH_TIME + ".\n"
    ...
    RPCHelpMan{
        ...
        RPCResult{
            ...
            CURRENCY_UNIT + ". This is negative and only available for the \n"
                            ...
                            "}\n"},
        RPCExamples{
            HelpExampleCli("gettransaction", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"") + HelpExampleCli("gettransaction", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\" true") + HelpExampleCli("gettransaction", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\" false true") + HelpExampleRpc("gettransaction", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"")},
    }
        .Check(request);
...
static UniValue getwalletinfo(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
        ...
        RPCResult{
            ...
            UNIX_EPOCH_TIME + " of the oldest pre-generated key in the key pool\n"
                              "  \"keypoolsize\" : xxxx,               (numeric) how many new keys are pre-generated (only counts external keys)\n"
                              "  \"keypoolsize_hd_internal\" : xxxx,   (numeric) how many new keys are pre-generated for internal use (used for change outputs, only appears if the wallet is using this feature, otherwise external keys are used)\n"
                              "  \"unlocked_until\" : ttt,             (numeric) the " +
            UNIX_EPOCH_TIME + " until which the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
...
static UniValue setwalletflag(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
        ...
        RPCResult{
            ...
            "}\n"},
        RPCExamples{
            HelpExampleCli("setwalletflag", "avoid_reuse") + HelpExampleRpc("setwalletflag", "\"avoid_reuse\"")},
    }
        .Check(request);
...
static UniValue bumpfee(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
        ...
        "Alternatively, the user can specify totalFee (DEPRECATED), or fee_rate (" +
            CURRENCY_UNIT + " per kB) for the new transaction .\n"
...
UniValue getaddressinfo(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
        ...
        RPCResult{
            ...
            "  \"timestamp\" : timestamp,            (number, optional) The creation time of the key, if available, expressed in " +
            UNIX_EPOCH_TIME + ".\n"
